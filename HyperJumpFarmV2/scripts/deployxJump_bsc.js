...
async function main() {
  ...
  if (chainId != 56) return; // bsc script
  ...
  const jump_address = "0x130025eE738A66E691E6A7a62381CB33c6d9Ae83";
  const jump_factory = await ethers.getContractFactory("HyperJumpToken");
  const jump = await jump_factory.attach(jump_address);

  const farm_address = "0x7A0De9A006129A18AE8d3C4e609fa866EE29A5B3";
